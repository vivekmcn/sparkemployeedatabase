<div class="employees index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('employeeposition_id'); ?></th>
			<th><?php echo $this->Paginator->sort('employeequalification_id'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($employees as $employee): ?>
	<tr>
		<td><?php echo h($employee['Employee']['id']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['fname']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['lname']); ?>&nbsp;</td>
                <td><?php echo $this->Html->image(Router::url('/',true).'app/webroot/files/Avatars/'.$employee['Employee']['image'],array('width' => '35px','height' => '35px')); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['dateofbirth']); ?>&nbsp;</td>
                <td><?php echo h($employee['Employee']['email']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['phone_number']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($employee['Employeeposition']['position_name'], array('controller' => 'employeepositions', 'action' => 'view', $employee['Employeeposition']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($employee['Employeequalification']['qualification_name'], array('controller' => 'employeequalifications', 'action' => 'view', $employee['Employeequalification']['id'])); ?>
		</td>
		<td class="actions">
