<div class="employeeCertifications index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($employeeCertification['Employee']['fname']." ".$employeeCertification['Employee']['lname  '], array('controller' => 'employees', 'action' => 'view', $employeeCertification['Employee']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($employeeCertification['Certification']['certification_name'], array('controller' => 'certifications', 'action' => 'view', $employeeCertification['Certification']['id'])); ?>
		</td>
